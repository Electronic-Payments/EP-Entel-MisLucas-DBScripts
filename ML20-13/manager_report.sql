...
DROP procedure IF EXISTS `generate_manager_report`;

DELIMITER $$
USE `EP_ENTEL_MISLUCAS`$$
CREATE PROCEDURE `generate_manager_report` ( -- call generate_manager_report(1, 10);
	IN p_page INT,
    IN p_page_size INT,
...
BEGIN   
	...
	SELECT
        ...
        CONCAT((vm.commerces_visited_level_1_2 / cm.total_commerces_level_1_2), '%') as commerces_visited_level_1_2_by_total_commerces_level_1_2__percentage,
        CONCAT((vm.commerces_visited_level_3_4 / cm.total_commerces_level_3_4), '%') as commerces_visited_level_3_4_by_total_commerces_level_3_4__percentage,
        CONCAT((vm.commerces_visited_level_5_6_7 / cm.total_commerces_level_5_6_7), '%') as commerces_visited_level_5_6_7_by_total_commerces_level_5_6_7__percentage,
